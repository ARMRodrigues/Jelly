...
VkFormat VulkanGraphicAPI::findDepthFormat() {
...
VkFormat VulkanGraphicAPI::findSupportedFormat(
...
void VulkanGraphicAPI::createRenderPass() {
    ...
    depthAttachment.format = findDepthFormat(); // implementar função que retorna VK_FORMAT_D32_SFLOAT ou equivalente
    ...
    depthAttachmentRef.attachment = 1; // segundo attachment
